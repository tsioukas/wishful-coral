...
"""
    ...
    Howto:
    1) activate the radio program using activate_radio_program(gr_scripts/wishful_wifi_transceiver.grc)
...
class WiFiGnuRadioModule(GnuRadioModule):
    ...
    @wishful_module.bind_function(upis.radio.get_bandwidth)
    ...
    @wishful_module.bind_function(upis.radio.set_rx_gain)
    ...
    @wishful_module.bind_function(upis.radio.get_rx_gain)
